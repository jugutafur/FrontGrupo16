...
export class PrincipalComponent {
  ...
  archives22 : Active []= [
    {
      ...
      valueActive  : 45000,
      datePurchuse  : new Date("2023/06/27"),
    },
    {
      id : 2,
      type : "maquinaria",
      ...
      valueActive  : 45000,
      datePurchuse  : new Date("2023/06/28"),
    },
    {
      id : 3,
      type : "inmueble",
      ...
      datePurchuse  : new Date("2023/06/29"),
    },
    {
      id : 4,
  ...
  searchDate(busquedaFecha: Date){
    ...
    console.log("valor de la fecha = "+this.fechaEnviar);

    const isMatchfecha = fecha => fecha.datePurchuse == this.fechaEnviar;
    console.log("valor de la fecha  = "+ isMatchfecha);

    this.activeTipe = this.archives22.filter(isMatchfecha)
    console.log("estos son mis activos de acuerdo a la fecha "+ this.tipoActivo);
    console.log(this.activeTipe);
  ...
  searchSerie(busquedaSerial: string){
    this.showTableType = true;
    console.log("this is importante "+this.busquedaSerial);
    const isMatchActivo = activo => activo.serial == this.busquedaSerial;
    this.activeTipe = this.archives22.filter(isMatchActivo)
    console.log("estos son mis activos de tipo "+ this.tipoActivo);
    console.log(this.activeTipe);
  }
